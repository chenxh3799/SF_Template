...
<sf:override name="content">
 ...
 <sfform:form modelAttribute="${classNameLower}" action="<@jspEl 'ctx'/>${className}/update">
	<div style="background: url(<@jspEl 'ctx'/>resources/images/banner.jpg)"
			align="left"><img
			src="<@jspEl 'ctx'/>resources/styles/ui/images/common/arrow1.gif"
			width="12" height="15" style="margin-left: 10px" class="arrow" />编辑
