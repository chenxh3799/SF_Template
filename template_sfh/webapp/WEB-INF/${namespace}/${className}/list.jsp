					...
					<td>
					    <a id="pk-<@jspEl 'item.'+table.pkColumn.columnNameLower/>-edit" href="<@jspEl 'flowExecutionUrl'/>">编辑</a>
				         <script type="text/javascript">
						    ...
						    event: "onclick",
						    params: {_eventId: "edit",${table.pkColumn.columnNameLower}:"<@jspEl 'item.'+table.pkColumn.columnNameLower/>"}	
					      }));
				          </script>
				         ...
				         <script type="text/javascript">
						    ...
						    event: "onclick",
						    params: {_eventId: "view",${table.pkColumn.columnNameLower}:"<@jspEl 'item.'+table.pkColumn.columnNameLower/>"}	
					      }));
				          </script>
				         ...
				         <script type="text/javascript">
						    ...
						    event: "onclick",
						    params: {_eventId: "remove",${table.pkColumn.columnNameLower}:"<@jspEl 'item.'+table.pkColumn.columnNameLower/>"}	
					      }));
				          </script>
                    </td>
				</tr>
