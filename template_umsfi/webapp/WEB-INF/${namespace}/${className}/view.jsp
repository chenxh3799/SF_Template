...
<img src="<@jspEl 'ctx'/>resources/styles/ui/images/common/arrow1.gif" width="12" height="15" style="margin-left:10px" class="arrow"/>查看
 ...
 <div class="content">
		...
		<div align="right">
		<button type="submit" id="back" name="_eventId_back" class="btn">返回</button>

		<script type="text/javascript">
						Spring.addDecoration(new Spring.AjaxEventDecoration({elementId:'"back"',event:'onclick',formId:'${classNameLower}'}));
					</script></div>
		</div>
	</sfform:form></div>
</sf:override>
